...
class FirstPersonCameraDemo {
  ...
  initializeScene_() {
    ...
    const texture = loader.load([
      './resources/MilkyWay/dark-s_px.jpg',
      './resources/MilkyWay/dark-s_nx.jpg',
      './resources/MilkyWay/dark-s_py.jpg',
      './resources/MilkyWay/dark-s_ny.jpg',
      './resources/MilkyWay/dark-s_pz.jpg',
      './resources/MilkyWay/dark-s_nz.jpg',
  ]);
    ...
    const checkerboard = mapLoader.load('resources/floor.png');
    ...
    const wall1 = new THREE.Mesh(
      new THREE.BoxGeometry(500, 500, 4),
      concreteMaterial);
